...
//          break;
   ...
   */
    ...
    /**
     * The names of instantiated elements 
     * @return List<String>
     */
    public List<ModelElementInformation> getElements() {
      List<String> elements  = new ArrayList<>();
      for(ModelElementInformation info : modelElementsList.getElements()) {
        elements.add(info.getName());
      }
      return modelElementsList.getElements();
    }
}
