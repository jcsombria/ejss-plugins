...
//  " com/digitprop/tonic/++";
  ...
  static final String EJS_CONSOLE = VERBOSE +  
          " -o Ejs/distribution/EjsConsole.jar "+
  ...
  " -o distribution/bin/comSun9.jar -v -m . org.colos.ejs._EjsSConstants"+
  " -c distribution/bin/osp.jar  "+
  " -s libraries/tools.jar "+
  " -x distribution/bin/osp.jar "+
