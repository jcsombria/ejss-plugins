...
public class EditorForInteraction2D extends EditorMultiuse {

  public static String edit (String _classname, String _property, String _type, javax.swing.JTextField returnField) {
    options = new String[] {"ENABLED_NONE", "ENABLED_ANY", "ENABLED_X", "ENABLED_Y", "ENABLED_NO_MOVE"};
    prefix = "Interaction2D";
    optionsPanel.setLayout(new java.awt.GridLayout(1,5,0,0));
    resetButtons();
