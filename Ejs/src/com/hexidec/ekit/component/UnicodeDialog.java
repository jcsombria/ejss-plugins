...
*/
	...
	private JComboBox<String> jcmbBlockSelector;
	private JComboBox<String> jcmbPageSelector;
	...
	public void init(int startIndex)
	{
		...
		jcmbBlockSelector = new JComboBox<String>(unicodeBlocks);
		...
		String[] sPages = { "1" };
		jcmbPageSelector = new JComboBox<String>(sPages);
