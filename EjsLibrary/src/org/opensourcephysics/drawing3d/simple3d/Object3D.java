 ...
 */
class Object3D {
  private final SimpleElement simpleElement;
  private int index;
  private double distance = Double.NaN;

  /**
   * Gets the simpleElement that contains this Object3D
   * @return Element
   */
  final SimpleElement getSimpleElement() {
   ...
   */
  public Object3D(SimpleElement _element, int _index) {
    this.simpleElement = _element;
    this.index = _index;
