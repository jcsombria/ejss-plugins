 ...
 * @version August 2009
 */
public class SimpleElementCylinder extends SimpleAbstractTile {

  public SimpleElementCylinder(ElementCylinder _element) { super(_element); }

  @Override
  protected double[][][] computeTile() {
    ElementCylinder cylinder = (ElementCylinder) element;
    int nr = 1, nu = 1, nz = 1;
    double angle1 = cylinder.getMinimumAngle(), angle2 = cylinder.getMaximumAngle();
