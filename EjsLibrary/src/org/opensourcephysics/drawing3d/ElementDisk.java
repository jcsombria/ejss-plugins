 ...
 * <p>Description: A 3D Circle</p>
 * 
 * @author Francisco Esquembre
 * @author Carlos Jara Bravo (CJB)
 * @version August 2010
 */
public class ElementDisk extends ElementCylinder {

  {
    getStyle().setResolution(new Resolution(5, 12, 1));
    this.setSizeXYZ(1,1,0);
  }
  
  /**
   * Constructor ElementDisk
   */
  @Override
  protected ImplementingObject createImplementingObject(int _implementation) {
    switch(_implementation) {
        ...
        case DrawingPanel3D.IMPLEMENTATION_SIMPLE3D : 
          return new org.opensourcephysics.drawing3d.simple3d.SimpleElementDisk(this);
        case DrawingPanel3D.IMPLEMENTATION_JAVA3D : 
          return new org.opensourcephysics.drawing3d.java3d.Java3dElementDisk(this);
    }
  }
