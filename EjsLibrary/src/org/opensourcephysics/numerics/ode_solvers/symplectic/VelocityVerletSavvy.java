...
/**
 * VelocityVerletSavvy is an interface for an ODE that provides 
 * extra information for the VelocityVerlet method
 *
 * @author Francisco Esquembre. February 2014
 */
public interface VelocityVerletSavvy {
   ...
   * does not depend on the velocity. Then, some methods (such as Velocity Verlet) can improve 
   ...
   * @return true if acceleration is independent of velocity.
   */
