 ...
 */
public class XuggleWriterVideoRecorder extends ScratchVideoRecorder {

//	private IRational time base = IRational.make(1, 9000);	
   ...
   */
  public XuggleWriterVideoRecorder(XuggleVideoType type) {
    super(type);
  }
