...
public class MetadataSensorActuatorModel extends MetadataModel {

  private static final String SENSORACTUATORID = "sensorActuatorId";
  ...
  public MetadataSensorActuatorModel(String actuatorID, String fullName){
    super("sensorActuator");
    loadBasicDesc();
    JsonArray req = Json.createArrayBuilder().add(SENSORACTUATORID).add(FULLNAME).build();
    setRequired(req);
  ...
  public MetadataSensorActuatorModel(String actuatorID, String fullName, String description, String websocketType,
  ...
  public void loadActuator(String actuatorID, String fullName, String description, String websocketType,
    ...
    propBuilder
    .add(SENSORACTUATORID,actuatorID)
  ...
  protected void loadBasicDesc(){
    JsonObject description = Json.createObjectBuilder()
        .add(SENSORACTUATORID, Json.createObjectBuilder()
            .add("type","String")
            .build())
