...
public class HardcopyWriter extends Writer {
  ...
  public HardcopyWriter(Frame frame, String jobname, int fontsize, double leftmargin, double rightmargin,
    ...
    if(System.getProperty("os.name").regionMatches(true, 0, "windows", 0, 7)) {
      ...
      // A4 = 210 x 297
      // 210 mm = 8.26770 Inches
      // 297 mm = 11.69289 Inches
      pagesize = new Dimension((int) (8.26770*pagedpi), (int) 11.69289*pagedpi);
      pagesize = new Dimension((int) (6.25*pagedpi), 9*pagedpi);
