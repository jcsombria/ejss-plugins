...
// ------------------------------------------------
  ...
  public void setValue (int _index, Value _value) {
    switch (_index) {
      case 0 : if (_value.getDouble()!=minX) {
        lattice.setMinMax(minX=_value.getDouble(),maxX,minY,maxY);
      }
      break;
    case 1 : if (_value.getDouble()!=maxX) { 
        lattice.setMinMax(minX,maxX=_value.getDouble(),minY,maxY); 
      }
      break;
    case 2 : if (_value.getDouble()!=minY) {
        lattice.setMinMax(minX,maxX,minY=_value.getDouble(),maxY);
      }
      break;
    case 3 : if (_value.getDouble()!=maxY) {
        lattice.setMinMax(minX,maxX,minY,maxY=_value.getDouble());
      }
      break;
      case 4 :
  ...
  protected void setColorMode (int _n, int _palette) {
    ...
    else lattice.setColorPalette(colors);
  }
