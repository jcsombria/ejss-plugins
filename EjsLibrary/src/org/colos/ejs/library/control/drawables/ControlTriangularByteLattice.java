...
public class ControlTriangularByteLattice extends ControlDrawable2D {
  static private final int TRIANGULAR_BYTE_LATTICE_ADDED = 8;
  ...
  protected Drawable createDrawable () {
    nx = 30;
    ny = 30;
    lattice = new TriangularByteLattice(nx,ny);
...
// ------------------------------------------------
  ...
  public void setValue (int _index, Value _value) {
    switch (_index) {
      ...
      default: super.setValue(_index-TRIANGULAR_BYTE_LATTICE_ADDED,_value);
    }
  }
  ...
  public void setDefaultValue (int _index) {
    switch (_index) {
      ...
      default: super.setDefaultValue(_index-TRIANGULAR_BYTE_LATTICE_ADDED); break;
    }
  }
  ...
  public String getDefaultValueString (int _index) {
    switch (_index) {
      ...
      case 7 : return "true";
      default : return super.getDefaultValueString(_index-TRIANGULAR_BYTE_LATTICE_ADDED);
    }
  }
  ...
  public Value getValue (int _index) {
    switch(_index) {
      ...
      case 5 : case 6 : case 7 : 
        return null;
      default: return super.getValue(_index-TRIANGULAR_BYTE_LATTICE_ADDED);
    }
  }
