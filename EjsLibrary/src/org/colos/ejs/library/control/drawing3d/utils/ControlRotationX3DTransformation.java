...
import org.opensourcephysics.drawing3d.utils.transformations.XAxisRotation;
 ...
 */
public class ControlRotationX3DTransformation extends ControlRotation3DTransformation {

  @Override
  protected Transformation createTransformation () {
    origin = new double[]{0.0,0.0,0.0};
    rotation = new XAxisRotation();
    return rotation;
  }
...
//------------------------------------------------
  ...
  public Object clone() {
    ControlRotationX3DTransformation ct = new ControlRotationX3DTransformation();
